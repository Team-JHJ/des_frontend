export default function Tooltip({ tooltipState }) {
    ...
    return (
        <div
            className={`absolute -right-[1.1rem] top-[160%] box-border min-w-48 cursor-default rounded-lg border border-black bg-white p-4 transition-opacity duration-300 ease-out ${
